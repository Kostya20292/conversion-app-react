...
| `[frontend-implementation-plan.md](./frontend-implementation-plan.md)` | Пошаговая реализация `apps/web`                |
| `[backend-implementation-plan.md](./backend-implementation-plan.md)`   | Пошаговая реализация `apps/api`                |
